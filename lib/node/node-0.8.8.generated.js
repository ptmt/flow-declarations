...
declare module "url" {
    ...
    declare function parse(urlStr: string, parseQueryString? , slashesDenoteHost? ): Url;
...
declare     class FSWatcher {
    ...
    declare function writeFile(filename: string, data: any, callback?: (err) => void): void;
    declare function writeFile(filename: string, data: any, encoding?: string, callback?: (err) => void): void;
