...
// Buffer class
class Buffer extends NodeBuffer {}
declare var Buffer: {
    new (str: string, encoding?: string): Buffer;
    new (size: number): Buffer;
    new (size: Uint8Array): Buffer;
...
declare module "stream" {
    ...
    declare class Readable extends events.EventEmitter extends NodeJS.ReadableStream {
        readable: boolean;
    ...
    declare class Writable extends events.EventEmitter extends NodeJS.WritableStream {
        writable: boolean;
    ...
    declare class Duplex extends Readable extends NodeJS.ReadWriteStream {
        writable: boolean;
    ...
    declare class Transform extends events.EventEmitter extends NodeJS.ReadWriteStream {
        readable: boolean;
        writable: boolean;
